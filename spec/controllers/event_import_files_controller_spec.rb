  ...
  describe "POST create" do
    describe "When logged in as Librarian" do
      ...
      it "should create event_import_file" do
        post :create, params: { event_import_file: {event_import: fixture_file_upload("files/event_import_file_sample1.tsv", 'text/csv') } }
      ...
      it "should import user" do
        ...
        post :create, params: { event_import_file: {event_import: fixture_file_upload("files/event_import_file_sample2.tsv", 'text/csv'), default_library_id: 3, default_event_category_id: 3 } }
