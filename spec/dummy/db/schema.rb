...
ActiveRecord::Schema.define(version: 20_161_112_085_723) do
  ...
  create_table 'agent_import_file_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key agent_import_file_id), name: 'index_agent_import_file_transitions_on_sort_key_and_file_id', unique: true, using: :btree
  end
  ...
  create_table 'checkouts', force: :cascade do |t|
    ...
    t.index %w(item_id basket_id), name: 'index_checkouts_on_item_id_and_basket_id', unique: true, using: :btree
  ...
  create_table 'event_export_file_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key event_export_file_id), name: 'index_event_export_file_transitions_on_sort_key_and_file_id', unique: true, using: :btree
  end
  ...
  create_table 'event_import_file_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key event_import_file_id), name: 'index_event_import_file_transitions_on_sort_key_and_file_id', unique: true, using: :btree
  end
  ...
  create_table 'identifiers', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(body identifier_type_id), name: 'index_identifiers_on_body_and_identifier_type_id', using: :btree
  ...
  create_table 'import_request_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key import_request_id), name: 'index_import_request_transitions_on_sort_key_and_request_id', unique: true, using: :btree
  end
  ...
  create_table 'lending_policies', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(item_id user_group_id), name: 'index_lending_policies_on_item_id_and_user_group_id', unique: true, using: :btree
  end
  ...
  create_table 'manifestation_checkout_stat_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key manifestation_checkout_stat_id), name: 'index_manifestation_checkout_stat_transitions_on_transition', unique: true, using: :btree
  end
  ...
  create_table 'manifestation_reserve_stat_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key manifestation_reserve_stat_id), name: 'index_manifestation_reserve_stat_transitions_on_transition', unique: true, using: :btree
  end
  ...
  create_table 'message_request_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key message_request_id), name: 'index_message_request_transitions_on_sort_key_and_request_id', unique: true, using: :btree
  end
  ...
  create_table 'message_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key message_id), name: 'index_message_transitions_on_sort_key_and_message_id', unique: true, using: :btree
  end
  ...
  create_table 'picture_files', force: :cascade do |t|
    ...
    t.string   'picture_id'
    t.index %w(picture_attachable_id picture_attachable_type), name: 'index_picture_files_on_picture_attachable_id_and_type', using: :btree
  ...
  create_table 'reserve_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key reserve_id), name: 'index_reserve_transitions_on_sort_key_and_reserve_id', unique: true, using: :btree
  end
  ...
  create_table 'resource_export_file_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key resource_export_file_id), name: 'index_resource_export_file_transitions_on_sort_key_and_file_id', unique: true, using: :btree
  end
  ...
  create_table 'resource_import_file_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key resource_import_file_id), name: 'index_resource_import_file_transitions_on_sort_key_and_file_id', unique: true, using: :btree
  end
  ...
  create_table 'user_checkout_stat_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(sort_key user_checkout_stat_id), name: 'index_user_checkout_stat_transitions_on_sort_key_and_stat_id', unique: true, using: :btree
  ...
  create_table 'user_export_file_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(sort_key user_export_file_id), name: 'index_user_export_file_transitions_on_sort_key_and_file_id', unique: true, using: :btree
  ...
  create_table 'user_import_file_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(sort_key user_import_file_id), name: 'index_user_import_file_transitions_on_sort_key_and_file_id', unique: true, using: :btree
  ...
  create_table 'user_reserve_stat_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(sort_key user_reserve_stat_id), name: 'index_user_reserve_stat_transitions_on_sort_key_and_stat_id', unique: true, using: :btree
